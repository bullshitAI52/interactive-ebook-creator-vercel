class BookEditor {
  ...
  initElements() {
    ...
    this.newPageInput = document.getElementById('new-page-input');
  ...
  bindEvents() {
    ...
    // 页面操作
    // 页面操作
    // this.addPageBtn.addEventListener('click', () => this.addPage()); // Moved to inline onclick
    if (this.newPageInput) {
      this.newPageInput.addEventListener('change', (e) => this.handleNewPageUpload(e));
    }
